    ...
    return (           
        <div className="faq-container">
            ...
            <div className={`faq-item ${activeItem === 1 ? 'active' : ''}`} onClick={() => handleItemClick(1)}>
                <div className="faq-question">O que é a PlayTV?</div>
                {activeItem === 1 && (
            ...
            <div className={`faq-item ${activeItem === 5 ? 'active' : ''}`} onClick={() => handleItemClick(5)}>
                ...
                {activeItem === 5 && (
                    <div className="faq-answer">
                        <p>A PlayTV tem um grande catálogo de filmes, documentários, séries, originais PlayTV premiados e muito mais. Assista o quanto quiser, quando quiser.</p>
                    </div>
                )}
            </div>
        </div>
